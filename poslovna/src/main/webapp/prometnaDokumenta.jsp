...
<body>
	...
	<div>
		<ul>
				<li class="group-start" id="searchD"><a href="searchModal" data-toggle="modal" data-target="#searchModal"><img src="../../images/search.gif" /></a></li>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<div id="form">
		      ...
		      <div class="modal-body">
				...
				<p>
					<label for="magacin">Status:</label>
				...
				<p>
					...
					<select  id="magacinS">	</select>
				</p>
				
				<p>
					<label for="Vrsta">Vrsta</label> <select name="vrsta"id="vrstaS" >
							<option>PR</option>
							<option>OT</option>
							<option>MM</option>
						</select>
